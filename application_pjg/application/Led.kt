...
class Led : AppCompatActivity() {
    ...
    lateinit var sensorAdapter: SensorDataListAdapter4
    lateinit var dataList: ArrayList<LedData>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sensorAdapter = SensorDataListAdapter4(dataList)
    ...
    private fun getAPI() {
        ...
        val retrofit = Retrofit.Builder()
            ...
            .build()
        val apiService = retrofit.create(Apiservice4::class.java)

        apiService.getLedData().enqueue(object : Callback<Map<String, Any>> {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (dataMap != null) {
                        ...
                        dataList.add(LedData(value1, value2, value3, value4))
