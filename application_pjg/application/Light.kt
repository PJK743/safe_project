...
class Light : AppCompatActivity() {
    ...
    lateinit var sensorAdapter: SensorDataListAdapter5
    lateinit var dataList: ArrayList<LightData>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sensorAdapter = SensorDataListAdapter5(dataList)
    ...
    private fun getAPI() {
        ...
        val retrofit = Retrofit.Builder()
            ...
            .build()
        val apiService = retrofit.create(Apiservice5::class.java)

        apiService.getLightData().enqueue(object : Callback<Map<String, Any>> {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (dataMap != null) {
                        ...
                        dataList.add(LightData(value1, value2, value3, value4))
