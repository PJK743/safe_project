...
class Flame : AppCompatActivity() {

    lateinit var sensorAdapter: SensorDataListAdapter
    lateinit var dataList: ArrayList<FlameData>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sensorAdapter = SensorDataListAdapter(dataList)
    ...
    private fun getAPI() {
        ...
        apiService.getFlameData().enqueue(object : Callback<Map<String, Any>> {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (dataMap != null) {
                        ...
                        dataList.add(FlameData(value1, value2, value3, value4))
